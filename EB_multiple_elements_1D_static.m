...
% AS 22/11/17
% 1 dimensional
% Equidistant mesh refinement is implemented in between two points

%%%%%%%%%%%%%%%%%%%%%
%%% Preprocessing %%%
%%%%%%%%%%%%%%%%%%%%%

clear variables     % clear the memory
...
M_element_sol = M_global;
M_element_sol(constrained_dof,:) = 0;
M_element_sol(:,constrained_dof) = 0;
M_element_sol(constrained_dof,constrained_dof) = eye(length(constrained_dof));

%%%%%%%%%%%%%%%%%%
%%% Processing %%%
%%%%%%%%%%%%%%%%%%

%% solving static or eigenvalue problem
...
%[U,C] = eig(K_element_sol,M_element_sol);
%%%%%%%%%%%%%%%%%%%%%%%
%%% Post processing %%%
%%%%%%%%%%%%%%%%%%%%%%%
...
for i = 1:length(x_coor)
    defl(i) = -1000*x_coor(i)^2*(3*L_beam-x_coor(i))/(6*E*I);
end
...
plot(x_coor,-defl)
%fnplt(pp)
legend('undeformed','deformed','Analytical')
